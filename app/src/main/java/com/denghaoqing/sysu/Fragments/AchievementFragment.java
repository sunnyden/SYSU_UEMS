...
import com.denghaoqing.sysu.Achievement.AchievementAdapter;
...
public class AchievementFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView listView = view.findViewById(R.id.score_list);
        RecyclerView.Adapter adapter = new AchievementAdapter(Achievement.getAchievementListWithCondition(getContext(), "select * from score", new String[]{}), getContext());
