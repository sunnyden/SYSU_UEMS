...
public class Course {
    ...
    public int week;
    public long startMills, endMills;
    public int[] sections;
    private long remainingTime;
    private String readableString = "";
    private GeneralSchedule generalSchedule;

    public Course(String courseName, String teacher, String classroom, long startTime, long endTime) {
        this.startMills = startTime;
        this.endMills = endTime;
        this.courseName = courseName;
        this.teacher = teacher;
        this.classroom = classroom;
        Calendar bgnTimeCal = Calendar.getInstance();
        bgnTimeCal.setTimeInMillis(startMills);
        Calendar endTimeCal = Calendar.getInstance();
        endTimeCal.setTimeInMillis(endMills);
        this.sections = GeneralSchedule.getSectionByTime(bgnTimeCal, endTimeCal);
    }
